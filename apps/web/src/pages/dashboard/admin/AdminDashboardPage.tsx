...
//         {/* Total Exams */}
//         <div className="relative overflow-hidden rounded-2xl bg-[#1d3557] px-6 py-6 text-white shadow-sm">
//           <div className="absolute right-[-20px] top-[-20px] text-white/5 opacity-40">
//             <svg
//               width="120"
//               height="120"
//               viewBox="0 0 24 24"
...
//         {/* Drafts */}
//         <div className="rounded-2xl bg-white px-6 py-6 shadow-sm border-l-4 border-slate-900 flex flex-col justify-center">
...
//         {/* Published */}
//         <div className="rounded-2xl bg-white px-6 py-6 shadow-sm border-l-4 border-emerald-400 flex flex-col justify-center">
//           <div className="flex items-center gap-2 mb-2">
//             <span className="text-xs font-bold tracking-widest text-slate-500 uppercase">
//               Published
//             </span>
...
//         {/* Completed */}
//         <div className="rounded-2xl bg-white px-6 py-6 shadow-sm border-l-4 border-red-500 flex flex-col justify-center">
//           <div className="flex items-center gap-2 mb-2">
//             <span className="text-xs font-bold tracking-widest text-slate-500 uppercase">
//               Completed
//             </span>
...
//           <div className="rounded-3xl bg-[#f8fafc] shadow-sm overflow-hidden flex flex-col px-1 pt-1 pb-1">
//             <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_60px] px-6 py-4 border-b border-gray-100 text-[10px] font-bold uppercase tracking-wider text-slate-500 mt-2">
//               <div>Exam Name</div>
//               <div>Start Date</div>
//               <div>End Date</div>
//               <div>No. of Shifts</div>
...
//                 <div
//                   key={exam.id}
//                   className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_60px] items-center px-6 py-5 bg-white rounded-2xl shadow-sm border border-slate-50"
//                 >
//                   <div>
...
//                       ID: #{String(exam.id).padStart(5, "0")}
//                     </p>
//                   </div>
...
//                   <div>
//                     <span
//                       className={`inline-flex items-center px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-widest border ${
...
//                       <button className="text-slate-400 hover:text-blue-600 transition p-2 hover:bg-blue-50 rounded-lg group">
//                         <Edit3 className="w-4 h-4 group-hover:text-blue-600" />
//                       </button>
//                     </Link>
//                   </div>
//                 </div>
...
//                   No exams found. Start by creating a new one.
//                 </div>
//               )}
//             </div>
//           </div>
      ...
      <section className="grid gap-8 lg:grid-cols-1">
        ...
        <div className="border border-slate-300 rounded-3xl overflow-hidden bg-white">
          ...
          <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_60px] bg-gradient-to-r from-slate-50 to-slate-100/50 px-6 py-4 border-b border-slate-300">
            <div className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Exam Name</div>
            <div className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Start Date</div>
            <div className="text-[11px] font-bold uppercase tracking-wider text-slate-600">End Date</div>
            <div className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Shifts</div>
            <div className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Subjects</div>
            <div className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Status</div>
            <div className="text-right text-[11px] font-bold uppercase tracking-wider text-slate-600">Action</div>
          </div>
          ...
          <div>
            ...
            {exams.length === 0 && (
              <div className="p-16 text-center">
                ...
                <h3 className="text-lg font-semibold text-slate-700 mb-2">No examinations found</h3>
                <p className="text-sm text-slate-500">Start by creating your first exam configuration</p>
              </div>
            )}
          </div>
        </div>
