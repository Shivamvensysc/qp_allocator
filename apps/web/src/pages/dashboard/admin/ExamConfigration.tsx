...
export default function ExamConfiguration() {
  ...
  const handleFieldBlur = (field: string) => {
    ...
    if (newShift.startTime && newShift.endTime) {
      const timeRangeError = validateTimeRange(newShift.startTime, newShift.endTime);
  ...
  const isAddShiftDisabled = () => {
    return !newShift.date || !newShift.startTime || !newShift.endTime || 
           !!shiftErrors.date || !!shiftErrors.startTime || !!shiftErrors.endTime || 
  ...
  const handleAddShift = () => {
    ...
    if (!dateError && !startTimeError && !endTimeError && !timeRangeError && 
        newShift.date && newShift.startTime && newShift.endTime) {
      setShifts([...shifts, { ...newShift }]);
      setNewShift({ date: "", startTime: "", endTime: "", type: "Morning" });
              ...
              <div className="bg-[#F8F9FA] rounded-2xl p-4 ">
                ...
                {isShiftBoxOpen && (
                  <div className="bg-white border border-slate-200 rounded-2xl p-4 md:p-6 mb-6 shadow-sm transition-all">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                      <div className="flex flex-col gap-1.5">
                        ...
                        >
                          <input
                            ...
                            className={`bg-slate-50 border rounded-xl px-4 py-2.5 text-sm text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none w-full cursor-pointer ${
                              touchedFields.date && shiftErrors.date ? 'border-red-500' : 'border-slate-200'
                            }`}
                            value={newShift.date}
                        ...
                        {touchedFields.date && shiftErrors.date && (
                          <p className="text-red-500 text-xs mt-1">{shiftErrors.date}</p>
                        )}
                      </div>
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                        ...
                        <input
                          ...
                          className={`bg-slate-50 border rounded-xl px-4 py-2.5 text-sm text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none w-full ${
                            touchedFields.startTime && shiftErrors.startTime ? 'border-red-500' : 'border-slate-200'
                          }`}
                          value={newShift.startTime}
                        ...
                        {touchedFields.startTime && shiftErrors.startTime && (
                          <p className="text-red-500 text-xs mt-1">{shiftErrors.startTime}</p>
                        )}
                      </div>
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                        ...
                        <input
                          type="time"
                          className={`bg-slate-50 border rounded-xl px-4 py-2.5 text-sm text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none w-full ${
                            touchedFields.endTime && shiftErrors.endTime ? 'border-red-500' : 'border-slate-200'
                          }`}
                          value={newShift.endTime}
                        ...
                        {touchedFields.endTime && shiftErrors.endTime && (
                          <p className="text-red-500 text-xs">{shiftErrors.endTime}</p>
                        )}
                      </div>
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                    ...
                    {shiftErrors.timeRange && (touchedFields.startTime || touchedFields.endTime) && (
                      <div className="mb-4 p-2 bg-red-50 border border-red-200 rounded-lg">
                        <p className="text-red-600 text-xs font-medium">{shiftErrors.timeRange}</p>
                      </div>
                    )}
